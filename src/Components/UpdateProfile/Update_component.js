...
export const Basic_Information = ({
  ...
  function handleImageChange(event) {
    ...
    // Create a temporary URL for the selected image and set it as the preview URL
        ...
        <form>
          <div>
            {imagePreviewUrl ? (
              ...
              <div>No profile image selected</div>
            )}
          </div>
          <div>
            ...
            {/* <input
              ...
              accept="image/*"
              onChange={handleImageChange}
              className="relative mt-4 debug block w-11 col-start-3 col-span-2 col-end-4 m-0 flex-auto cursor-pointer rounded border border-solid border-neutral-300 bg-white bg-clip-padding px-3 py-1.5 text-base font-normal text-neutral-700 outline-none transition duration-300 ease-in-out file:-mx-3 file:-my-1.5 file:cursor-pointer file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-neutral-100 file:px-3 file:py-1.5 file:text-neutral-700 file:transition file:duration-150 file:ease-in-out file:[margin-inline-end:0.75rem] file:[border-inline-end-width:1px] hover:file:bg-neutral-200 focus:border-primary focus:bg-white focus:text-neutral-700 focus:shadow-[0_0_0_1px] focus:shadow-primary focus:outline-none dark:bg-transparent dark:text-neutral-200 dark:focus:bg-transparent"
            /> */}
          </div>
...
export const Organization__ = ({
  ...
  const NextMove = () => {
    let data = {
      ...
      grade: organisation_Data.position_level_id,
      role: organisation_Data.role,
      department: organisation_Data.department_id,
  ...
  let newdepartment = userProfileData2?.profile.department;
          ...
          <div className="justify-between  flex  w-full  Up_input gap-2 ">
            <div className="div_input  w-[50%]  ">
              ...
              <input
                ...
                type="text"
                // name="grade"
                placeholder={userProfileData2.position.name}
                disabled={Admin_user_ === 1 ? false : true}
              />
  ...
  return (
    <>
      <div className="whole_basicinfo" class="scroll-smooth">
        <div className="">
          <div className="formfield_update">
            {/* <div class="border border-gray-300 px-10 py-14 rounded-lg w-full bg-gray-100 font-manrope font-extrabold text-base leading-6 text-gray-700"> */}

            <div className="text-gray-700 border px-2 py-2  border-gray-300 rounded-lg bg-gray-100 font-manrope font-extrabold text-base">
              <p className="mb-5"> Education History</p>
